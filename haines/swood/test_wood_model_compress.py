...
# Train...
p = ProgBar()
sw = SWood(int_dm, real_dm, cats, tree_count = tree_count, option_count = option_count, weight = weight, callback=p.callback, compress=True)
del p
...
# Test...
mod.test_multi(sw.multi_classify)
